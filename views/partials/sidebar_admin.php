...
<asside class="sidebar sidebar-toggle d-flex flex-column flex-shrink-0 p-3 text-bg-dark" id="sidebar" style="width: 280px; height: auto;">
    ...
    <ul class="sidebar-nav nav nav-pills flex-column mb-auto">
      <li>
        <a href="/inventory-app/public/" class="nav-link text-white d-flex align-items-center">
      ...
      <li>
        <a href="/inventory-app/modules/users" class="nav-link text-white d-flex align-items-center">
          <i class="bi bi-person-circle me-2 fs-4"></i>
            <p class="m-0 p-0" id="ts">User</p>
        </a>
      </li>
    </ul>
  </asside>