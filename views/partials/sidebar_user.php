...
<asside class="sidebar sidebar-toggle d-flex flex-column flex-shrink-0 p-3 text-bg-dark" id="sidebar" style="width: 280px; height: auto;">
    <a href="/inventory-app/modules/dashboard.php" class=" d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none mx-auto" style="padding-top: 5rem;">
